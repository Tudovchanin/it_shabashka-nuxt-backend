...
export const COLOR_SHADOW_MAP = {
  ...
  'gold': "gold",
  'blue': "blue",
  'linear-gradient(90deg, #e2632c,#fb4955,#ff3286,#fc39be,#d35bf8)': "#d35bf8",
  'linear-gradient(90deg, #ee6ef5,#57b9ff)': '#57b9ff',
  'linear-gradient(90deg, #29482a,#4e8950,#9fb97f)': "#9fb97f",
